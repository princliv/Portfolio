...
export const ProfilesSection = memo(function ProfilesSection() {
  ...
  return (
    <section className="scroll-snap-section relative z-20 bg-white dark:bg-background/95 border-t border-slate-200/80 dark:border-border/40 section-padding overflow-hidden">
