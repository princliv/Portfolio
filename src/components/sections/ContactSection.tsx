...
export const ContactSection = memo(function ContactSection() {
  return (
    <section id="contact-section" className="relative z-20 pt-20 md:pt-12 lg:pt-20 pb-20 md:pb-12 lg:pb-20 bg-[#eef2ff] dark:bg-background/95 border-t border-slate-200/80 dark:border-border/40 shadow-2xl">
